...
execute as @e[tag=craft_steel] at @s run kill @e[type=item,nbt={Item:{id:"minecraft:iron_ingot",Count:1b}}, distance=..1] 
execute as @e[tag=craft_steel] at @s run kill @e[type=item,nbt={Item:{id:"minecraft:coal", Count:2b}}, distance=..1] 
execute as @e[tag=craft_steel] at @s run kill @e[type=item,nbt={Item:{id:"minecraft:blaze_powder",Count:1b}}, distance=..1]
